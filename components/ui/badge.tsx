...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded border font-medium leading-none whitespace-nowrap transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
