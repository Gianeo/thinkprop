...
const STORY_STEPS: StoryStepData[] = [
  ...
  },
  {
    ...
    headline: "The urgency is clear. She can act directly from Today's Focus.",
    body: `Reem immediately sees what needs attention: the critical alert, the top-priority card in Today's Focus, and the highlighted step in Your Path.\n\nShe doesn't need to search around the platform. She clicks "Enroll to a Course" from Today's Focus and moves straight into action.`,
  ...
  },
  {
    ...
    headline: 'The drawer opens. Review, select, enroll.',
    body: `A right-side drawer opens with a suggested course and full details. Reem can accept it, or browse for a better fit.\n\nShe reviews the option, checks the session availability, and proceeds confidently to enroll.`,
  ...
  },
  {
    ...
    body: `She selects a session and clicks Enroll. The drawer closes, then a confirmation modal appears with booking details and a clear "Add to Calendar" option.\n\nThe course fee is covered by Prestige Properties Dubai's training account. Reem never sees a payment form. There is no checkout friction.`,
